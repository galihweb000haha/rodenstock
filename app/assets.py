...
def compile_static_assets(app):
    ...
    account_less_bundle = Bundle(
        ...
        filters="less,cssmin",
        output="static/dist/css/account.css",
        extra={"rel": "stylesheet/less"},
    )
    dashboard_less_bundle = Bundle(
        "static/src/less/dashboard.less",
        filters="less,cssmin",
        output="static/dist/css/dashboard.css",
        extra={"rel": "stylesheet/less"},
    )
    # JavaScript Bundle
    js_bundle = Bundle("static/src/js/main.js", filters="jsmin", output="static/dist/js/main.min.js")
    # Register assets
